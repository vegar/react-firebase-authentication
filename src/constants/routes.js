...
export const ADMIN = { url: '/admin', name: 'Admin' };
export const PASSWORD_FORGET = { url: '/pw-forget', name: 'Forgot password' };

export const ROUTES = [
    LANDING, SIGN_IN, SIGN_UP, HOME, ACCOUNT, ADMIN, PASSWORD_FORGET
]
